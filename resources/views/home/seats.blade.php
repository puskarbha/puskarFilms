...
{{$errors}}
        <ul class="seat--list ">
            @foreach($seats as $seat)
                <li>
                    <button class="btn text-white btn-success" onclick="toggleSeats(this, '{{ $seat->seat_name }}')">{{ $seat->seat_name }}</button>
                </li>
            @endforeach
        </ul>
        ...
        function toggleSeats(button, seat_no) {
            ...
            if (!existingInput) {
                if (count < limit) {
                    ...
                    console.log(`Input field appended for seat_no: ${seat_no}`);
                    count++;

                    // Toggle color of the clicked button
                ...
                console.log(`Input field removed for seat_no: ${seat_no}`);
                count--;
