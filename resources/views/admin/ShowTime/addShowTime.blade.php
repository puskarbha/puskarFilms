    ...
    <div class="addBranch--form container mt-4">
        <form method="POST" action="{{ route('show_times.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <select name="branch_id" id="branchName" class="form-select" onchange="hallSetup()">
            ...
            <div class="mb-3">
                ...
                <div class="form-check-container pl-3">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status" id="comingSoon" value="Coming_soon"
                               checked>
